...
public class SecurityValidationSteps {
    ...
    public void aLoginRequestIsMadeWithValidCredentials() {
        ...
        testContext.setCustomerId(response.jsonPath().getInt("id"));
    }
    ...
    public void theResponseShouldContainAValidCustomerId() {
        ...
        Assert.assertTrue(testContext.getCustomerId() > 0,
                "Expected a valid customer id greater than 0 but got: " + testContext.getCustomerId());
    }
